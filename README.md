...
The directory "robotic_combat_game" contains a Python implementation of CED (with a GNN-based representation of multi-agent policy) in this large-scale two-team adversarial game (Team Square vs. Team Circle). The directory also includes the comparative methods of behavior cloning and offline self-play.
