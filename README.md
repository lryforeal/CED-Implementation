...
The directory "robotic_combat_game" contains a Python implementation of CED combined with graph neural networks in this large-scale two-team adversarial game. It also contains the comparative methods of behavior cloning and offline self-play. Below is an illustration of the robotic combat game (Team Square vs. Team Circle).
